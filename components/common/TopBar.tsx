        ...
        <div className={clsx(
          ...
          <div className="p-6 border-b border-white/5 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="relative w-9 h-9 bg-black border border-white/10 rounded-xl flex items-center justify-center font-black text-xl text-white">
                <span className="text-neon-blue">P</span>
                <span className="text-[8px] absolute -bottom-1 -right-1 bg-neon-blue text-black px-1 rounded-sm">F</span>
              </div>
          ...
          <div className="p-6 border-t border-white/5 bg-black/20">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div className="min-w-0">
                ...
                <div className="text-[9px] text-zinc-600 font-bold uppercase tracking-tighter">{isAdmin ? 'System Admin' : 'Standard'}</div>
              </div>
            </div>
