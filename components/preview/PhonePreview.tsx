...
export const PhonePreview: React.FC<Props> = ({ profile, clientPlan }) => {
  return (
    <div className="relative group w-full flex items-center justify-center">
      {/* Chassis Externo */}
      <div
        className="relative mx-auto bg-[#050505] rounded-[3rem] border border-white/10 shadow-[0_50px_100px_-20px_rgba(0,0,0,1)] ring-1 ring-white/5 flex items-center justify-center p-[6px] transition-transform duration-700 group-hover:scale-[1.01]"
        style={{
      ...
      >
        {/* Tela */}
        <div className="relative w-full h-full bg-black rounded-[2.6rem] overflow-hidden border border-[#080808]">
          {/* Dynamic Island */}
